...
import { addNotes, updateDealAction } from "../redux/actions/deal";
import { getStages } from "../redux/actions/stage";
import {  getDeal } from "../redux/actions/deal";
...
function DetailDealSide({
  ...
  return (
    <>
      <div className="w-100 side-main salesboard">
        <div
                    ...
                    <Fragment key={org._id}>
                      <div className="d-flex align-items-center mb-10">
                        ...
                        <div className="text-dark text-break w-50">
                          {org.column_slug && org.column_slug === "stage" ? (
                            <>
                              <div
                                className="round round-sm"
                                style={{
                                  backgroundColor: `${detail["stage_color"]}`,
                                }}
                              />
                              {detail[org.column_slug]}
                            </>
                          ) : org.column_slug &&
                            org.column_slug === "phone" &&
                            detail[org.column_slug] ? (
                            <a href={`tel:${detail[org.column_slug]}`}>
                              {detail[org.column_slug]}
                            </a>
                          ) : org.column_slug &&
                            org.column_slug === "email" &&
                            detail[org.column_slug] ? (
                            <a href={`mailto:${detail[org.column_slug]}`}>
                              {detail[org.column_slug]}
                            </a>
                          ) : (
                            detail[org.column_slug]
                  ...
                  <div className="card-text">
                    ...
                    <span>
                      {detail["is_deal_won"] === 0
                        ? `Status: This deal is lost.`
                        : detail["is_deal_won"] === 1
                        ? `Status: This deal is won.`
                        : "Status: This deal is pending."}
                    </span>
                  </div>
                </div>
              </div>
                          ...
                          /> */}
                            ...
                            >
                              <img
                                alt=""
                                height="16px"
                                src={`assets/img/notes/${
                                  note_keys[note.notes_type]["icon"]
                                }`}
                              />
                            </span>
                            <span className="text-muted font-weight-bold">
                              {note.title
                                ? note.title
                                : note_keys[note.notes_type]["title"]}
                            </span>
                            <span
                            ...
                            >
                              <Link
                                to={`/${
                                  note_keys[note.notes_type]["link"]
                                }?redirectId=${note.ref_id}`}
                              >
                ...
                <form onSubmit={handleNoteSubmit}>
                  <div className="d-flex align-items-center mb-10">
                    ...
                    <div
                      ...
                      className="round round-md ml-2 addNoteBtn"
                      style={{ cursor: "pointer" }}
                    >
                      {" "}
